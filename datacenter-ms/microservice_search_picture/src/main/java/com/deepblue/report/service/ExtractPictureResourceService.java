...
import com.deepblue.report.entity.Position;
import com.deepblue.report.tools.*;
...
//        map1.put("picture_number",new Position(27,2));
    ...
    * */
    private boolean unzip(String zipFileName,PictureResource pictureResource) {
        ...
        UnzipUtil.unZip(zipFileName,zipOutputFilePath + SEPARATOR);
        ...
        {
            pictureResource.setPath((file.getParent()+ new File(zipFileName).getParent().replace(this.localFilePath,"")));
        }
        //获取解压后的文件夹路径
//        String path = zipFileName.substring(0,zipFileName.lastIndexOf("."));
     ...
     private boolean getDemoPictures(String unzipFold,List<String> arrayList,List<String> absolutePath){
         //System.out.println("unzipFold: "+ unzipFold);
